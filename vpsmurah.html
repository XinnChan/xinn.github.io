...
<head>
  <meta charset="UTF-8">
  <title>VPS MURAH XC FIXXED</title>
  <meta name="viewport"
...
<div class="wrapper">
  <div class="profile-card js-profile-card">
    ...
    <a href="https://html-css-js.xinnchan.repl.co/" class="profile card" target="_blank">
      <img src="https://cdn.filestackcontent.com/U8MC978Rsay0KKzDXL0A" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">XinnClay Fixxed</div>
      <div class="profile-card__txt">Owner <strong>XCDDOS</strong></div>
      ...
      <div class="profile-card-inf">
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">8.527.633+</div>
        ...
        <div class="profile-card-inf__item">
          <div class="profile-card-inf__title">88.833.467+</div>
      ...
      <div class="profile-card-social">
        <a href="https://www.facebook.com/profile.php?id=100011130630165" class="profile-card-social__item facebook" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-facebook"></use></svg>
          </span>
        </a>

        <a href="https://instagram.com/xinnchan_795?igshid=MzNlNGNkZWQ4Mg==" class="profile-card-social__item instagram" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-instagram"></use></svg>
          </span>
        </a>

        <!-- <a href="https://github.com/XinnChan" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-github"></use></svg>
          </span>
        </a>  -->

        <a href="https://youtube.com/@xinnclay" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
      ...
      <div class="profile-card-ctr">
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 1 GB 20.000 / 5$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 2 GB 40.000 / 10$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 4 GB 70.000 / 15$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 8 GB 90.000 / 20$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 16 GB 240.000 / 25$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 32 GB 300.000 / 30$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 64 GB 500.000 / 40$</a>
                            <span class="icon-font">
                            </span>
                          </a>
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">VPS RAM 120 GB 900.000 / 60$</a>
                            <span class="icon-font">
                            </span>
                          </a>
            </div>
            ...
            <div class="profile-card-ctr">
                  <a href="https://t.me/XinnClay_Fixxed" class="profile-card__button button--blue js-message-btn" target="_blank">Order? Klick Here!</a>
                            <span class="icon-font">
                            </span>
                          </a>
            </div>
...
<div class="profile-card-ctr">
              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">Vps Buat bahan Hosting Dan lainnya disini sangat murah dan berkualitas</a>
                            <span class="icon-font">
                            </span>
                          </a>

              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">Vps Bulanan Support All Tools seperti DDoS, Mining, Tracking, Dll Garansi 20 hari jika sebelum 20 hari VPS bermasalah maka akan di gantikan dengan yang baru!</a>
                            <span class="icon-font">
                            </span>
                          </a>

              <a href="" class="profile-card__button button--blue js-message-btn" target="_blank">Buruan di order nunggu apa lagi!</a>
                            <span class="icon-font">
                            </span>
                          </a>
        </div>
